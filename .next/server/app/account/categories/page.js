...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 77400)), "C:\\Users\\mesol\\Documents\\lenguajes\\mundo html\\proyectos\\react\\ecommerce\\frontend-ecommerce\\src\\app\\account\\categories\\page.jsx"],
    ...
    const pages = ["C:\\Users\\mesol\\Documents\\lenguajes\\mundo html\\proyectos\\react\\ecommerce\\frontend-ecommerce\\src\\app\\account\\categories\\page.jsx"];
    ...
    const originalPathname = "/account/categories/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 67188))
...
// EXTERNAL MODULE: ./src/components/datatable/Datatable.jsx + 1 modules
var Datatable = __webpack_require__(86828);
;// CONCATENATED MODULE: ./src/components/lists/ListOfCategories.js
        ...
        cell: (info)=>{
            ...
            return /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx(dropdown/* default */.Z, {
                    linkEdit: `/account/categories/e${id}`
                })
            });
        },
        enableSorting: false
...
function ListOfCategories({ data =[]  }) {
    return /*#__PURE__*/ jsx_runtime_.jsx(Datatable/* default */.Z, {
        title: "Categorias",
...
// EXTERNAL MODULE: ./src/hooks/useCategories.js
var useCategories = __webpack_require__(73811);
// EXTERNAL MODULE: external "next/dist/compiled/react"
var react_ = __webpack_require__(18038);
;// CONCATENATED MODULE: ./src/app/account/categories/page.jsx
/* __next_internal_client_entry_do_not_use__ default auto */ 
...
function Page() {
    ...
    const { getAllCategories  } = (0,useCategories/* useCategories */.L)();
    (0,react_.useEffect)(()=>{
        getAllCategories().then((response)=>{
            setCategories(response);
        });
    }, []);
    return /*#__PURE__*/ jsx_runtime_.jsx(ListOfCategories, {
        data: categories
    });
}
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\mesol\Documents\lenguajes\mundo html\proyectos\react\ecommerce\frontend-ecommerce\src\app\account\categories\page.jsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [9405,4235,5430,3981,7970,9950,442,6828,3811], () => (__webpack_exec__(66703)));
