...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 50498)), "C:\\Users\\mesol\\Documents\\lenguajes\\mundo html\\proyectos\\react\\ecommerce\\frontend-ecommerce\\src\\app\\account\\users\\[info]\\page.jsx"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 44824)), "C:\\Users\\mesol\\Documents\\lenguajes\\mundo html\\proyectos\\react\\ecommerce\\frontend-ecommerce\\src\\app\\account\\layout.js"],
          metadata: {
    ...
    const pages = ["C:\\Users\\mesol\\Documents\\lenguajes\\mundo html\\proyectos\\react\\ecommerce\\frontend-ecommerce\\src\\app\\account\\users\\[info]\\page.jsx"];
    ...
    const originalPathname = "/account/users/[info]/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 76311))
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FormUser)
/* harmony export */ });
...
/* harmony import */ var _InputGroup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28914);
/* harmony import */ var _button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(39950);
/* harmony import */ var _Toggle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(98455);
/* harmony import */ var _utils_crud__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(45903);
/* harmony import */ var _utils_expressions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(86726);
/* harmony import */ var _hooks_useUsers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(47410);
/* harmony import */ var _utils_alerts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(85338);
/* harmony import */ var _Select__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(68508);
/* harmony import */ var _hooks_useRoles__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(41181);
...
function FormUser({ action ="a" , id =""  }) {
    const { register , handleSubmit , formState: { errors  } , setValue  } = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_11__/* .useForm */ .cI)({
        mode: "onChange"
    });
    const [roles, setRoles] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const { isActionEdit , isActionAdd  } = (0,_utils_crud__WEBPACK_IMPORTED_MODULE_5__/* .getValidateAction */ .w8)({
        action
    });
    const { getActivedRoles  } = (0,_hooks_useRoles__WEBPACK_IMPORTED_MODULE_10__/* .useRoles */ .d)();
    const { addNewUser , editUser , getOneUser  } = (0,_hooks_useUsers__WEBPACK_IMPORTED_MODULE_7__/* .useUsers */ .U)();
    ...
    const handleSubmitOwn = async (data)=>{
        const { password ="password" , confirmPassword ="confirmPassword" , state  } = data;
        const areEqualPasswords = Boolean(password === confirmPassword);
        if (isActionAdd && !areEqualPasswords) {
            (0,_utils_alerts__WEBPACK_IMPORTED_MODULE_8__/* .setMessageError */ .G)({
                message: "Las contrase\xf1as no son iguales"
            });
            return;
        }
        const dataToSend = {
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
        ...
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h2", {
                className: "text-brand-dark text-base lg:text-lg xl:text-[20px] font-semibold xl:leading-8 mb-5 md:mb-6 lg:mb-7 lg:-mt-1",
                children: "Datos del usuario"
            }),
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                className: "grid lg:grid-cols-2 gap-5",
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_InputGroup__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
                        name: "username",
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_InputGroup__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
                        ...
                        validations: {
                            ...register("email", {
                                required: true,
                                pattern: _utils_expressions__WEBPACK_IMPORTED_MODULE_6__/* .expressions.email */ .m.email
                            })
                        }
                    }),
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Select__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z, {
                        label: "Rol",
                        items: roles,
                        validations: {
                            ...register("idRole")
            ...
            !isActionEdit && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                className: "grid lg:grid-cols-2 gap-5",
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_InputGroup__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
                        name: "password",
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                ...
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Toggle__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
                    validations: {
                        ...register("state")
                    }
                })
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_button__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {
                label: `${(0,_utils_crud__WEBPACK_IMPORTED_MODULE_5__/* .getNameAction */ .fM)({
                    action
                })}`,
                type: "submit",
                full: true
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "m": () => (/* binding */ expressions)
/* harmony export */ });
const expressions = {
...
// EXTERNAL MODULE: ./src/utils/crud.js
var crud = __webpack_require__(68717);
// EXTERNAL MODULE: ./node_modules/next/dist/build/webpack/loaders/next-flight-loader/module-proxy.js
var module_proxy = __webpack_require__(21313);
;// CONCATENATED MODULE: ./src/components/form/FormUser.js

const proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\mesol\Documents\lenguajes\mundo html\proyectos\react\ecommerce\frontend-ecommerce\src\components\form\FormUser.js`)
...
/* harmony default export */ const FormUser = (__default__);
;// CONCATENATED MODULE: ./src/app/account/users/[info]/page.jsx



function Page({ params  }) {
    const { info ="U1234"  } = params;
    const { action , id  } = (0,crud/* getParams */.Qf)(info);
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: action === "P" ? /*#__PURE__*/ (0,jsx_runtime_.jsxs)("h1", {
            children: [
                "Preview ",
                id
            ]
        }) : /*#__PURE__*/ jsx_runtime_.jsx(FormUser, {
            id: id,
            action: action
        })
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [9405,4235,5430,1031,7970,9950,442,8914,8455,2275,1181,8508,7410], () => (__webpack_exec__(70637)));
