...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 33477)), "C:\\Users\\mesol\\Documents\\lenguajes\\mundo html\\proyectos\\react\\ecommerce\\frontend-ecommerce\\src\\app\\account\\products\\page.jsx"],
    ...
    const pages = ["C:\\Users\\mesol\\Documents\\lenguajes\\mundo html\\proyectos\\react\\ecommerce\\frontend-ecommerce\\src\\app\\account\\products\\page.jsx"];
    ...
    const originalPathname = "/account/products/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 42916))
...
;// CONCATENATED MODULE: ./src/components/lists/ListOfProducts.js
...
const COLUMNS = [
    ...
    },
    {
        ...
        cell: (info)=>/*#__PURE__*/ jsx_runtime_.jsx("span", {
                children: MONEDA + info.getValue().toFixed(2)
            })
    },
    {
        ...
        cell: (info)=>{
            ...
            return /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx(dropdown/* default */.Z, {
                    linkEdit: `/account/products/e${id}`
                })
            });
        },
        enableSorting: false
...
// EXTERNAL MODULE: ./src/hooks/useProducts.js
var useProducts = __webpack_require__(89918);
// EXTERNAL MODULE: external "next/dist/compiled/react"
var react_ = __webpack_require__(18038);
;// CONCATENATED MODULE: ./src/app/account/products/page.jsx
/* __next_internal_client_entry_do_not_use__ default auto */ 
...
function Page() {
    ...
    const { getAllProducts  } = (0,useProducts/* useProducts */.r)();
    (0,react_.useEffect)(()=>{
        getAllProducts().then((response)=>{
            setProducts(response);
        });
    }, []);
    return /*#__PURE__*/ jsx_runtime_.jsx(ListOfProducts, {
        data: products
    });
}
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\mesol\Documents\lenguajes\mundo html\proyectos\react\ecommerce\frontend-ecommerce\src\app\account\products\page.jsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [9405,4235,5430,3981,7970,9950,442,6828,9918], () => (__webpack_exec__(50017)));
