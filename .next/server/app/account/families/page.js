...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 37482)), "C:\\Users\\mesol\\Documents\\lenguajes\\mundo html\\proyectos\\react\\ecommerce\\frontend-ecommerce\\src\\app\\account\\families\\page.jsx"],
    ...
    const pages = ["C:\\Users\\mesol\\Documents\\lenguajes\\mundo html\\proyectos\\react\\ecommerce\\frontend-ecommerce\\src\\app\\account\\families\\page.jsx"];
    ...
    const originalPathname = "/account/families/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1956))
...
;// CONCATENATED MODULE: ./src/components/lists/ListOfFamilies.js
        ...
        cell: (info)=>{
            ...
            return /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx(dropdown/* default */.Z, {
                    linkEdit: `/account/families/e${id}`
                })
            });
        },
        enableSorting: false
...
;// CONCATENATED MODULE: ./src/app/account/families/page.jsx
/* __next_internal_client_entry_do_not_use__ default auto */ 
...
function Page() {
    ...
    const { getAllFamilies  } = (0,useFamilies/* useFamilies */.L)();
    (0,react_.useEffect)(()=>{
        getAllFamilies().then((response)=>{
            setFamilies(response);
        });
    }, []);
    return /*#__PURE__*/ jsx_runtime_.jsx(ListOfFamilies, {
        data: families
    });
}
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\mesol\Documents\lenguajes\mundo html\proyectos\react\ecommerce\frontend-ecommerce\src\app\account\families\page.jsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [9405,4235,5430,3981,7970,9950,442,6828], () => (__webpack_exec__(74767)));
