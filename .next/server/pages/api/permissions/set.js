...
async function handler(req, res) {
    try {
        ...
        const body = req.body;
        const url = `${_settings_envs__WEBPACK_IMPORTED_MODULE_0__/* .API_URL_SERVER_BACKEND */ .Bj}/permission/many`;
...
var __webpack_exports__ = __webpack_require__.X(0, [3425], () => (__webpack_exec__(78110)));
